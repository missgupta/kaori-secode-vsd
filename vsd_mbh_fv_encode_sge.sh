...
echo [$HOSTNAME] [$JOB_ID] [matlab -nodisplay -r "densetraj_encode_fv_sge( '$1', '$2', '$3', $4, $5 )"]
# change to the code dir  --> NEW!!! *** CHANGED ***
cd /net/per900a/raid0/plsang/tools/kaori-secode-vsd2013
...
matlab -nodisplay -r "densetraj_encode_fv_sge( '$1', '$2', '$3', $4, $5 )"
# Log ending time
date
