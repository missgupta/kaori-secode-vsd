...
%   Detailed explanation goes here
	...
	output_file = sprintf('/net/per610a/export/das11f/ledduy/plsang/vsd2013/feature/bow.codebook.devel/densetrajectory.%s/data/codebook.%d.mat', descriptor, cluster_count);
	if exist(output_file, 'file'),
		fprintf('File [%s] already exists. skipped!\n', output_file);
		return;
	end
	
	selected_feat_file = sprintf('/net/per610a/export/das11f/ledduy/plsang/vsd2013/feature/bow.codebook.devel/densetrajectory.%s/data/selected_feats_%d.mat', descriptor, max_features);
