function mfcc_extract_features(szPat)
	...
	feat_dir = '/net/per610a/export/das11f/plsang/vsd2013/feature/keyframe-5/mfcc.rastamat.raw';
	
	for ii=1:length(videos),
		video_id = videos{ii};
		output_file = sprintf('%s/%s/%s.mat', feat_dir, szPat, video_id);
...
%   Detailed explanation goes here
	...
	audio_dir = '/net/per610a/export/das11f/plsang/vsd2013/audio';
